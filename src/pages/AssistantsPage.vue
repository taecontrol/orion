  ...
  <div class="max-w-xl mx-auto mt-10">
    ...
    <div class="flex justify-end mt-4">
      <router-link
        ...
        class="flex items-center p-2 space-x-1 text-indigo-500 rounded-full hover:underline"
      >
